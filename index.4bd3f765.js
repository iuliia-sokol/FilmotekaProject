 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ht=new k(5e3,15e3),Vt={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},$t=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function Kt(e){const t=e.config;v(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?S(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,s={apiKey:t.apiKey,appName:e.name,v:i.SDK_VERSION},o=$t.get(e.config.apiHost);o&&(s.eid=o);const a=e._getFrameworks();return a.length&&(s.fw=a.join(",")),`${n}?${(0,r.querystring)(s).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vt{static empty(){return new Vt(new Ht(null))}constructor(e){this.writeTree_=e}}function $t(e,t,n){if(Ie(t))return new Vt(new Ht(n));{const r=e.writeTree_.findRootMostValueAndPath(t);if(null!=r){const i=r.path;let s=r.value;const o=xe(i,t);return s=s.updateChild(o,n),new Vt(e.writeTree_.set(i,s))}{const r=new Ht(n),i=e.writeTree_.setTree(t,r);return new Vt(i)}}}function Kt(e,t,n){let r=e;return U(n,((e,n)=>{r=$t(r,Ee(t,e),n)})),r}function Gt(e,t){if(Ie(t))return Vt.empty();{const n=e.writeTree_.setTree(t,new Ht(null));return new Vt(n)}}function Jt(e,t){return null!=Yt(e,t)}function Yt(e,t){const n=e.writeTree_.findRootMostValueAndPath(t);return null!=n?e.writeTree_.get(n.path).getChild(xe(n.path,t)):null}function Qt(e){const t=[],n=e.writeTree_.value;return null!=n?n.isLeafNode()||n.forEachChild(Qe,((e,n)=>{t.push(new De(e,n))})):e.writeTree_.children.inorderTraversal(((e,n)=>{null!=n.value&&t.push(new De(e,n.value))})),t}function Xt(e,t){if(Ie(t))return e;{const n=Yt(e,t);return new Vt(null!=n?new Ht(n):e.writeTree_.subtree(t))}}function Zt(e){return e.writeTree_.isEmpty()}function en(e,t){return tn(ge(),e.writeTree_,t)}function tn(e,t,n){if(null!=t.value)return n.updateChild(e,t.value);{let r=null;return t.children.inorderTraversal(((t,i)=>{".priority"===t?((0,o.assert)(null!==i.value,"Priority writes must always be leaf nodes"),r=i.value):n=tn(Ee(e,t),i,n)})),n.getChild(e).isEmpty()||null===r||(n=n.updateChild(Ee(e,".priority"),r)),n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */Ui=r.SDK_VERSION,h=Ui,(0,r._registerComponent)(new(0,i.Component)("database",((e,{instanceIdentifier:t})=>Pi(e.getProvider("app").getImmediate(),e.getProvider("auth-internal"),e.getProvider("app-check-internal"),t)),"PUBLIC").setMultipleInstances(!0)),(0,r.registerVersion)(c,u,Mi),(0,r.registerVersion)(c,u,"esm2017")})),s.register("3TVVy",(function(e,n){t(e.exports,"scrollFunction",(function(){return i}));var r=s("90HKd");function i(){r.refs.btnUp.addEventListener("click",(()=>{window.scrollTo({top:0,behavior:"smooth"})})),document.body.scrollTop>30||document.documentElement.scrollTop>30?r.refs.btnUpWrapper.style.display="flex":r.refs.btnUpWrapper.style.display="none"}}));
//# sourceMappingURL=index.4bd3f765.js.map
